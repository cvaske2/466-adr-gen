...
def peer_to_peer_frame(parent):
    new_frame = ttk.Frame(parent, padding=10)
    new_frame.grid()
    ttk.Label(new_frame, text="This is a peer to peer style frame!").grid(column=0, row=0)
    ...
    ttk.Label(new_frame, text="Communication:").grid(column = 0, row=9)
    
    layering_entry = ttk.Entry(new_frame)
    layering_entry.grid(column=1, row=10)

    ttk.Label(new_frame, text="Data Storage:").grid(column = 0, row=11)
    
    communication_entry = ttk.Entry(new_frame)
    communication_entry.grid(column=1, row=12)

    ttk.Label(new_frame, text="Security:").grid(column = 0, row=13)
